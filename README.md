...
- [langgraph-workflows](https://github.com/mustafaskyer/langgraph-workflows): LangGraph.js workflows and AI orchestration practice.
- [hono-sequential-mcp-server](https://github.com/mustafaskyer/hono-sequential-mcp-server): TypeScript backend experiments around Hono and MCP.
- [hono_with_vite](https://github.com/mustafaskyer/hono_with_vite): Hono with a modern Vite setup.
- [orpc-contract-example](https://github.com/mustafaskyer/orpc-contract-example): contract-first TypeScript APIs with oRPC.
- [simple-mcp](https://github.com/mustafaskyer/simple-mcp): MCP learning and server-side integration experiments.
- [rigel-rn](https://github.com/mustafaskyer/rigel-rn): React Native starter architecture with Redux, sagas, maps, notifications, hooks, and performance topics.
- [rigel-cli](https://github.com/mustafaskyer/rigel-cli): React Native CLI tooling for screens, components, Redux files, and app structure.
- [rust-embeddings](https://github.com/mustafaskyer/rust-embeddings): Rust embeddings exploration with fastembed and ONNX Runtime.
- [rust-web-server-example](https://github.com/mustafaskyer/rust-web-server-example), [rocket-101](https://github.com/mustafaskyer/rocket-101), and [concurrency](https://github.com/mustafaskyer/concurrency): Rust backend and systems practice.
...
| --- | ---: |
| GitHub-counted contributions | **2,824** |
| Public commits | 300 |
| Public pull requests opened | 17 |
| Public pull request reviews | 0 |
| Public issues opened | 1 |
| Public repositories created | 93 |
| Restricted/private contributions | 2,413 |

Last synced from GitHub: 2026-09-04.

### Recent public activity

- 2026-09-03: Starred [lloydrichards/effect-boxes](https://github.com/lloydrichards/effect-boxes).
- 2026-09-03: Pushed to [rel-kit/relkit](https://github.com/rel-kit/relkit) on [fix/readable-dev-logs-and-traces](https://github.com/rel-kit/relkit/compare/cf1612ade68604c3566fcd3f7779691dd3de6593...4c33aa9219ce835be046f4f6e5b3df1f6a5e5c1d).
- 2026-09-03: Pushed to [rel-kit/relkit](https://github.com/rel-kit/relkit) on [main](https://github.com/rel-kit/relkit/compare/09756714080b71050b13f6d49990aa17a2527189...c0fa594825068cd3ea6f830de3b561888387ba10).
- 2026-09-03: Pushed to [rel-kit/relkit](https://github.com/rel-kit/relkit) on [fix/readable-dev-logs-and-traces](https://github.com/rel-kit/relkit/compare/9a1d79a2eed4462da7a01ecf00571c0a730c1246...cf1612ade68604c3566fcd3f7779691dd3de6593).
- 2026-09-03: Pushed to [rel-kit/relkit](https://github.com/rel-kit/relkit) on [changeset-release/main](https://github.com/rel-kit/relkit/compare/b2dd424c17110c87b204cf9464427ffb149851cc...e95dc69f2c41c34180d2c0e6588fef26a5d9d6d8).
<!-- GITHUB-ACTIVITY:END -->
